  ...
  container.innerHTML = `
    <div class="section-header mb-4">
      ...
      <div class="flex gap-2">
        <span style="font-size:11px;color:var(--text-muted);font-family:var(--font-mono);">${persons.length} Personen · ${relationships.length} Verbindungen</span>
        <button class="btn btn-ghost btn-sm" id="btn-center-graph">⊙ Zentrieren</button>
      </div>
    </div>
